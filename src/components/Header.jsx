...
const Header = ({ onGroupChange, onOrderChange }) => {
  ...
  const handleGroupChange = (event) => {
    ...
    onGroupChange(event.target.value); // Notify parent about group change
  };

  const handleOrderChange = (event) => {
    setOrderBy(event.target.value);
    onOrderChange(event.target.value); // Notify parent about order change
  };
        ...
        {dropdownVisible && (
          <div className="dropdown-menu">
            <div className="dropdown-group">
              ...
              <select value={groupBy} onChange={handleGroupChange} style={{width:"50%",marginLeft:"10px",marginTop:"-5px"}}>
            ...
            <div className="dropdown-order">
              ...
              <select value={orderBy} onChange={handleOrderChange} style={{width:"50%",marginLeft:"10px",marginTop:"-5px"}}>
                <option value="Priority">Priority</option>
